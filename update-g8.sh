...
if [[ -d ./src/main/g8 ]]; then
   ...
   sbt "run --noclear --force --source ../../target/sandbox/cross-scala --target ../.. --name cross-scala.g8  --package com.github --description cross-scala.g8  -K libraryName=Hello+World githubUser=Artur+Opala" -Dbuild.test.command="sbt +test" 
